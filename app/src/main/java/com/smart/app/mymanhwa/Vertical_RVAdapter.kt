...
import kotlinx.android.synthetic.main.vertical_heard.view.*
import kotlinx.android.synthetic.main.vertical_item.view.*

class Vertical_RVAdapter(private val category: String, private val subcategory: ArrayList<String>, private val colors: ArrayList<ArrayList<Horizontal_RVModel>>) : Section(
    SectionParameters.builder().itemResourceId(R.layout.vertical_item).headerResourceId(R.layout.vertical_heard).build()) {
